...
import landingHero from "../images/bayc-mutant-hero.jpg";
...
const Hero = () => {
  return (
    ...
    // </section>
    <section>
      <div className="heroParent max-w-full">
        <img src={landingLogo} alt="landingLogo" className="heroLogo" />
        <div className="landingSocials">
          <Social />
        </div>
        <img src={landingHero} alt="landingHero" className="landingHero" />
        <div className="heroChild mb-8 md:mb-0  md:text-left bg-black">
          <h5
            className="h1 lg:text-6xl text-3xl mb-4  font-extrabold text-white heading "
            data-aos="fade-down"
          >
            WELCOME TO THE BORED APE YACHT CLUB
          </h5>
          ...
          <form
            className="mt-8 border-b-2 border-slate-300 "
            data-aos="fade-down"
            data-aos-delay="300"
          >
            <Link
              className=" btn text-white hover:bg-teal-400  bg-yellow-500 py-3 px-10 hover:bg-yellow-300 transition duration-300 ease-in-out items-center flex justify-around rounded-md animate-bounce"
              to="/home"
            >
              Enter
            </Link>
      ...
      <div
        className="my-14 max-w-6xl mx-auto px-4 sm:px-6  pb-14 border-b-2 border-slate-400
      "
      >
        <p
